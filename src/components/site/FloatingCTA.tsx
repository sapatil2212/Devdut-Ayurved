  ...
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-40 flex flex-col items-center gap-2 md:gap-3">
      ...
      <motion.a
        ...
        className="grid size-10 md:size-14 place-items-center rounded-full bg-[#25D366] text-white shadow-lg ring-1 ring-[#25D366]/40"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4 md:size-6" aria-hidden="true">
