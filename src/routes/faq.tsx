...
const faqs = [
  ...
  { q: "What happens in a first consultation?", a: "60 minutes with Dr. Ganesh Kumar Patil. Detailed history, Nadi Pariksha (pulse), Prakriti and current-state assessment, root-cause discussion, and a written plan you leave with." },
